...
*/
add_action( 'init', 'red_hero_image_single_title_load_text_domain' );

function red_hero_image_single_title_load_text_domain() {
 ...
 */
function red_hero_image_single_title_register_block() {
	...
	wp_register_style(
		'red-hero-image-single-title-editor',
	...
	register_block_type( 'red-gutenberg-blocks/red-hero-image-single-title', array(
		'style' => 'red-hero-image-single-title',
		'editor_style' => 'red-hero-image-single-title-editor',
		'script' => 'red-hero-image-single-title',
	) );
	...
	// 	'red-hero-image-single-title',
	// 	sprintf(
	// 		'var red_hero_image_single_title = { localeData: %s };',
...
add_action( 'init', 'red_hero_image_single_title_register_block' );
